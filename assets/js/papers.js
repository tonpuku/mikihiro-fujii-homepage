...
\[
  ...
  \leqslant
  \begin{cases}
    Ct^{-\frac{3}{2}(1-\frac{1}{p})}(1+|\Omega|t)^{-\frac{3}{2}(1-\frac{2}{p})}\| f \|_{L^1} & (2 \leqslant p < 4),
    \\
    Ct^{-\frac{3}{2}(1-\frac{1}{4})}(1+|\Omega|t)^{-\frac{3}{4}}(\log(e+|\Omega|t))^{\frac{1}{4}}\| f \|_{L^1}, & (p=4)
    \\
    Ct^{-\frac{3}{2}(1-\frac{1}{p})}(1+|\Omega|t)^{-(1-\frac{1}{p})}\| f \|_{L^1} & (4<p \leqslant \infty)
  \end{cases}
\]
