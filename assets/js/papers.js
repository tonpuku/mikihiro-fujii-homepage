...
\]
where $f$ is a given divergence-free external force.
...
In the proof, we do not use convex integration. Instead, we combine Golovkin's classical method for the nonuniqueness of solutions to elliptic equations with a quadratic nonlinearity, with calculations that exploits the symmetries of the flow to control the inverse-cascade generated by the nonlinear term.`,
      "ja": String.raw`本研究では定常 Navier-Stokes 方程式の定常問題
\[
  -\Delta u + \mathbb P (u \cdot \nabla)u = f, \qquad \operatorname{div}u = 0,
\]
の解の一意性について考察する．ここで $f$ は発散零の所与の外力である．

空間次元が $n \geqslant 3$ であるとき，$\mathbb R^n$ 上での臨界空間における可解性は，小さな外力 $f \in \dot W^{-2,n}(\mathbb R^n)$ に対する小さい解 $u \in L^n(\mathbb R^n)$ の一意存在性が Chen (1993, Pacific J. Math.) によって知られている．この定理の 2 次元版は長らく未解決であった．

近年，この 2 次元の未解決問題を一意性の観点から否定的に解決する研究が進んでおり，Lemarié-Rieusset (2025, J. Funct. Anal.) は 2 次元トーラス上で零外力に対する非自明解 $u \in \dot H^{-1}(\mathbb T^2)$ を構成した．この結果は Ashkarian-Bhargava-Gismondi-Novack (2025, preprint) によって $u \in \dot H^{-\varepsilon}(\mathbb T^2) \cap L^{2-\varepsilon}(\mathbb T^2)$ ($\varepsilon>0$) へと改良された．また，Cheskidov-Hou (2026, preprint) は $B_{p,q}^{s}(\mathbb T^2)$ ($1 \leqslant p,q \leqslant \infty$, $s<0$) における解の非一意性を証明した．これらの非一意解の構成には，近年急速に発展してきた convex integration の手法を用いており，それに従った解の構成手順の事情により，解は非常に特異的であることが必要とされ，$L^2$ に属する解の一意性には届かないものであった．また，これらの非一意性の結果はすべてトーラス上の解である一方，2 次元定常 Navier-Stokes 方程式の全平面 $\mathbb R^2$ 上での解を構成することは ( 特定の特殊解のまわりでの解析を除き ) 大変困難であることが Stokes の Paradox として知られている．一方で，$L^2(\mathbb R^2)$ よりわずかに狭い $\dot B_{2,1}^0(\mathbb R^2)$ においては小さな解の一意性が成立する．

本研究では，任意の $q>1$ と $\varepsilon>0$ に対して，ある外力 $f \in \dot B_{2,q}^{-1}(\mathbb R^2)$ が存在して，この外力に対する $\mathbb R^2$ 上の定常 Navier-Stokes 方程式は少なくとも 2 つの異なる解 $u^+,u^- \in \dot B_{2,q}^{-1}(\mathbb R^2)$ を持ち，
\[
  \| u^+ \|_{\dot B_{2,q}^0} + \| u^- \|_{\dot B_{2,q}^0} + \| f \|_{\dot B_{2,q}^{-2}} < \varepsilon
\]
を満たすことを証明する．
...
証明では convex integration を用いずに，2 次の非線形項を持つ楕円形方程式の解の非一意性を論じる古典的な Golovkin の手法と，流れの対称性によって非線形項の逆カスケード流を制御する計算を組み合わせる．`
  ...
  },
  {
    ...
    "preprintUrl": "https://arxiv.org/abs/2607.05237",
    "preprintLabel": "arXiv",
    "journalUrl": "",
    "journal": "Submitted",
    "newUntil": "2026-10-06",
...
本稿の主結果では，これらの評価に対応する時間減衰が非線形解に対しても得られることを証明し，さらにその評価が最適であることを下からの評価によって証明した．`
  ...
  },
  {
    ...
    "title": "Analyticity in space and time for global solutions to the anisotropic Navier-Stokes equations in the critical $L^p(\\mathbb{R}^3)$ framework",
    "listTitle": "Analyticity in space and time for global solutions to the anisotropic Navier-Stokes equations in the critical $L^p(\\mathbb{R}^3)$ framework",
  ...
  },
  {
    ...
    "detailJournal": "Nonlinear Analysis 270 (2026), 114126",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Archive for Rational Mechanics and Analysis 250 (2026), no. 2, 19",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "authors": "Mikihiro Fujii, Yang Li, Pengcheng Mu",
    ...
    "detailJournal": "Bulletin of the London Mathematical Society 58 (2026), no. 3, e70312",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "title": "Linear and Nonlinear Stability for the Three Dimensional Stratified Boussinesq Equations with Horizontal Viscosity and Diffusivity",
    "listTitle": "Linear and Nonlinear Stability for the Three Dimensional Stratified Boussinesq Equations with Horizontal Viscosity and Diffusivity",
    "authors": "Mikihiro Fujii, Yang Li",
    ...
    "detailJournal": "SIAM Journal on Mathematical Analysis 58 (2026), no. 1, pp. 411-449",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Journal of Mathematical Fluid Mechanics 28 (2026), no. 1, 13",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "preprintLabel": "arXiv",
    "journalUrl": "https://ems.press/journals/aihpc/articles/14299336",
    "journal": "Annales de l'Institut Henri Poincaré C, Analyse Non Linéaire (2026)",
    "detailJournal": "Annales de l'Institut Henri Poincaré C, Analyse Non Linéaire 43 (2026), no. 5, pp. 1043-1077",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Mathematische Annalen 393 (2025), no. 1, pp. 215-239",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Journal of Differential Equations 435 (2025), 113298",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "journal": "Journal of Differential Equations (2025)",
    "detailJournal": "Journal of Differential Equations 428 (2025), pp. 747-795",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Calculus of Variations and Partial Differential Equations 64 (2025), no. 1, 29",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "journal": "International Mathematics Research Notices (2025)",
    "detailJournal": "International Mathematics Research Notices 2025 (2025), no. 1, rnae265",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Mathematische Nachrichten 297 (2024), no. 12, pp. 4401-4415",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Journal of Mathematical Analysis and Applications 536 (2024), no. 2, 128231",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Annals of PDE 10 (2024), no. 1, 10",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "journal": "Mathematische Nachrichten (2024)",
    "detailJournal": "Mathematische Nachrichten 297 (2024), no. 5, pp. 1678-1693",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Mathematische Annalen 388 (2024), no. 4, pp. 4083-4134",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "title": "Global well-posedness of the incompressible Hall-MHD system in critical spaces",
    "authors": "Mikihiro Fujii",
    "preprintUrl": "",
    "preprintLabel": "",
    "journalUrl": "https://link.springer.com/article/10.1007/s00028-023-00933-8",
    "journal": "Journal of Evolution Equations (2024)",
    "detailJournal": "Journal of Evolution Equations 24 (2024), no. 1, 3",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Nonlinear Analysis: Real World Applications 71 (2023), 103821",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Journal of the Mathematical Society of Japan 75 (2023), no. 1, pp. 51-71",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Journal of Evolution Equations 22 (2022), no. 1, 24",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Journal of Mathematical Analysis and Applications 504 (2021), no. 1, 125322",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
  },
  {
    ...
    "detailJournal": "Journal of Mathematical Fluid Mechanics 23 (2021), no. 1, 12",
    "abstract": {
      "en": "The original abstract is available from the arXiv, HAL, or journal link below.",
      "ja": "元のアブストラクトは下記の arXiv・HAL・ジャーナルリンクから確認できます。"
    }
